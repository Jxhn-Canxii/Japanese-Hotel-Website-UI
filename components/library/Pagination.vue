        ...
        <ul class="flex items-center space-x-1 text-base">
          <li>
            ...
            >
              ...
              <font-awesome :icon="faAngleDoubleLeft" />
            </button>
          </li>
          <li>
            <button
            ...
            >
              ...
              <font-awesome :icon="faChevronLeft" />
            </button>
          </li>
          <li
            ...
            <button
              :class="
                props.page_number === pn
                  ? 'text-white hover:bg-yellow-300 '+DEFAULT_BG
                  : ''
              "
          ...
          <li>
            ...
            >
              ...
              <font-awesome :icon="faChevronRight" />
            </button>
          </li>
          <li>
            <button
            ...
            >
              ...
              <font-awesome :icon="faAngleDoubleRight" />
            </button>
          </li>
        </ul>
      </nav>
...
import { pageInfo, page_number, generate_page_number } from '~/pages/utility/Pagination';
